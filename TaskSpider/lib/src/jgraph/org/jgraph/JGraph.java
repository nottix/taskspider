...
//DO NOT REMOVE OR MODIFY THIS LINE!
	...
	public static final String VERSION = "JGraph (v5.10.2.1)";
	...
	/** Whether or not to use pre-5.10 painting methods */
	protected boolean useLegacyPainting = false;
	...
	public Graphics getOffgraphics() {
		if (useLegacyPainting) {
			return getTransparentOffgraphics();
		}
		if (!isDoubleBuffered()) {
	 ...
	 * @return the off screen graphics
	 */
	public Graphics getTransparentOffgraphics() {
	...
	public boolean drawImage(int dx1, int dy1, int dx2, int dy2, int sx1,
		...
		if (useLegacyPainting) {
			return drawTransparentImage(dx1, dy1, dx2, dy2, sx1, sy1, sx2, sy2);
		} else {
			getOffgraphics();
	 ...
	 *         complete; <code>false</code> otherwise.
	 */
	public boolean drawTransparentImage(int dx1, int dy1, int dx2, int dy2, int sx1,
			int sy1, int sx2, int sy2) {
		Rectangle rect = getBounds();
		if ((offscreen == null)
				|| (offscreen instanceof BufferedImage && ((((BufferedImage) offscreen)
	...
	/**
	 * @return the useLegacyPainting
	 */
	public boolean isUseLegacyPainting() {
		return useLegacyPainting;
	}

	/**
	 * @param useLegacyPainting the useLegacyPainting to set
	 */
	public void setUseLegacyPainting(boolean useLegacyPainting) {
		this.useLegacyPainting = useLegacyPainting;
	}
