...
public class BasicGraphUI extends GraphUI implements Serializable {
	...
	public void paint(Graphics g, JComponent c) {
		...
		if (graph.isUseLegacyPainting()) {
			paintTransparentComponent(g, c);
		} else {
	...
	/**
	 * Copy of JGraph 5.9.x painting routine for painting transparent JGraphs
	 * correctly
	 */
	public void paintTransparentComponent(Graphics g, JComponent c) {
		Graphics2D g2 = (Graphics2D) g;
